...
# Scale carLeft and carRight to 20% of their original size
...
def crash():
    ...
    message_display("YOU CRASHED", 0, 0, red, 0)  # Display message without delay
    while True:
...
def game_loop():
    ...
    while not gameExit:
        ...
        if x > display_width - car_width or x < 0:
            crash()
            return  # Exit game_loop after crash to avoid further updates
